...
Mhstype Mahasiswa; //Menginput dari kb 
...
cout<<"Masukan Kode Pos : "; cin.getline(Mahasiswa.address.zip,10); //Mencetak hasil inputan cout<<endl; 
cout<<Mahasiswa.name.FirstName<<" "; cout<<Mahasiswa.name.LastName<<endl; 
cout<<Mahasiswa.address.street<<endl; cout<<Mahasiswa.address.city<<endl; 
